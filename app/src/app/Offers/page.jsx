    ...
    return (
        <div>
            ...
            <div className='ml-[300px] mt-3 flex flex-row'>
                <h1 className='text-[20px] font-semibold ml-[-20px] mt-[4px]'>Offers</h1>
                ...
                <button className='mr-[-10px] ml-5 hover:bg-black hover:text-white hover:border-none border-2 w-[90px] rounded-[30px]'>Revised</button>
                <button className='mr-[-10px] ml-5 hover:bg-black hover:text-white hover:border-none border-2 w-[70px] h-[35px] rounded-[30px]'>Paid</button>
                <button className='mr-[-10px] ml-5 hover:bg-black hover:text-white hover:border-none border-2 w-[95px] h-[35px] rounded-[30px]'>Rejected</button>
            ...
            <div>
                ...
                <p className='absolute w-[250px] ml-[720px] mt-[120px] text-gray-400'>No products added yet. After adding your products, you can send an offer rquest.</p>
                <button onClick={addProductTableOpen} className='mr-[-10px] ml-[770px] hover:bg-black hover:text-white hover:border-none w-[140px] bg-black h-[35px] text-white rounded-[30px] mt-[210px] '>+ Add Product</button>
            </div>
