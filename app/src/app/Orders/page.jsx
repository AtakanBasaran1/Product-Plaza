    ...
    return (
        <div>
            ...
            <div className='ml-[300px] mt-3 flex flex-row'>
                <h1 className='text-[20px] font-semibold ml-[-20px] mt-[4px]'>Orders</h1>
                ...
                <button className='mr-[-10px] ml-5 hover:bg-black hover:text-white hover:border-none border-2 w-[105px] h-[35px] rounded-[30px]'>Production</button>
                <button className='mr-[-10px] ml-5 hover:bg-black hover:text-white hover:border-none border-2 w-[135px] rounded-[30px]'>Quality Control</button>
                <button className='mr-[-10px] ml-5 hover:bg-black hover:text-white hover:border-none border-2 w-[75px] h-[35px] rounded-[30px]'>Transit</button>
                <button className='mr-[-10px] ml-5 hover:bg-black hover:text-white hover:border-none border-2 w-[105px] h-[35px] rounded-[30px]'>Completed</button>
            </div>
            <div>
                <FaMagnifyingGlass className='text-[23px] text-gray-300 ml-[288px] top-[30px] relative z-10' />

                <input
                    className='ml-[275px] mt-0 border-2 rounded-[30px] h-[36px] w-[900px]  placeholder:text-gray-500 pl-11 m-2 border border-gray-300'
                    type="text" placeholder='Search by material, color or product name' />
            </div>
            <div className='relative ml-[790px] mt-[-45px] '>
                <button className='ml-[400px] border-2 hover:bg-black hover:text-white hover:border-none w-[48px] h-[35px] mr-2 rounded-[30px]'>All</button>
                <button className=' mt-[-60px] border-2 ml-[1px] hover:bg-black hover:text-white hover:border-none w-[115px] h-[35px] mr-2 rounded-[30px]'>Fabric Type</button>
                <button className=' border-2 hover:bg-black hover:text-white hover:border-none w-[145px] h-[35px] ml-[0px] rounded-[30px]'>Sample Product</button>
            </div>
            <div>
                <FaMagnifyingGlass className='text-[130px] text-gray-300 ml-[750px] top-[100px] relative z-10' />
                <p className='absolute w-[250px] ml-[720px] mt-[120px] text-gray-400'>No products in process yet.</p>
            </div>
